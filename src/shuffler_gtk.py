...
class ShufflerWindow(Gtk.Window):
    def __init__(self):
        ...
        file = Gio.File.new_for_path(self.icon_path)
        ...
        hbox2.pack_start(button_tar, False, False, 0)
    ...
    def set_icon_from_file(self):
        ...
        icon_path = os.path.join(base_dir, "images", "io.github.jasonritchie06.mp3shuffler.svg") # for when we run locally
        if os.path.exists(icon_path):
            return icon_path

        elif os.path.exists("/app/share/icons/hicolor/scalable/apps/io.github.jasonritchie06.mp3shuffler.svg"):  # when running in a flatpak
            icon_path = "/app/share/icons/hicolor/scalable/apps/io.github.jasonritchie06.mp3shuffler.svg"
            return icon_path
        else:
            return None
    ...
    def get_tar_folder(self, widget):
        ...
        # user_run_path = f"/foo/run/media/{os.getlogin()}"
        # alt_user_run_path = f"/foo/run/user/{os.getuid()}/media/{os.getlogin()}"
