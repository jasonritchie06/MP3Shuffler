...
class ShufflerWindow(Gtk.Window):
    def __init__(self):
        ...
        self.icon = GdkPixbuf.Pixbuf.new_from_file(os.path.join(self.app_path, "io.github.jasonritchie06.mp3shuffler.png"))
        notification = Gio.Notification()
        notification.set_title("MP3 Shuffler is ready")
        notification.set_body("MP3 Shuffler is ready")

        file = Gio.File.new_for_path(self.get_resource_path("io.github.jasonritchie06.mp3shuffler48.png"))
